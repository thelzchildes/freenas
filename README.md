...
# Upgrade plex-pass
```
setenv ALLOW_UNSUPPORTED_SYSTEM yes && setenv BATCH yes && portsnap fetch update && cd /usr/ports/ports-mgmt/portmaster && make deinstall clean && make install clean && portmaster -Gaydf --no-confirm && sysrc plexmediaserver_plexpass_enable=YES && service plexmediaserver_plexpass start
```
