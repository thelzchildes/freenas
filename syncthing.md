...
```
```
rm rm /var/run/syncthing.pid && chown -R merc:merc /usr/local/etc/syncthing && chown -R merc:merc /var/tmp/syncthing && chown -R merc:merc /var/log/syncthing.log && chown -R merc:merc /var/mail/syncthing
```
```
